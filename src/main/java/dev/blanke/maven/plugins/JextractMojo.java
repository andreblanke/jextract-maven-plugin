...
public final class JextractMojo extends AbstractMojo {
    ...
    /**
     * List of paths from which files {@code #include}'d from the {@link #headerFile} should be resolved.
     */
    @Parameter(alias = "includes")
    private List<String> includePaths = new ArrayList<>();

    /**
     * Directory into which the source files generated by {@code jextract} should be output.
     *
     * The directory is added as a compilation root for the <pre><a href="https://maven.apache.org/plugins/
     * maven-compiler-plugin/">maven-compiler-plugin</a></pre>.
     *
     * Defaults to {@code ${project.build.directory}/generated-sources/jextract}
     * (usually {@code target/generated-sources/jextract}).
     */
    @Parameter(
    ...
    /**
     * Name of the Java class which should be generated for the set {@link #headerFile}.
     */
    ...
    /**
     * Name of the package the generated Java classes should belong to.
     */
    @Parameter(
